...
const Signup = () => {
    ...
    const handleSubmit = async(e)=>{
      ...
      try {
        let res = await axios.post('http://localhost:8080/users/register', obj);
  ...
  <div className="grid lg:grid-cols-2 md:grid-cols-2 items-center h-[80vh] gap-4">
    ...
    <form className="max-w-xl w-full text-white p-6 mx-auto">
      <div className="mb-12 text-white">
        <h3 className="text-white text-4xl font-extrabold">Sign Up</h3>
      ...
      <div>
        ...
        <div className="relative flex mb-5 items-center">
          <input ref={nameRef} name="name" type="text" required className="w-full text-sm text-white border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter name" />
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
        ...
        <div>
          <a href="jajvascript:void(0);" className="text-white font-semibold text-sm hover:underline">
            Forgot Password?
          </a>
        </div>
      </div>
